...
export const HERO = {
  ...
  sub: 'Вывожу магазины на маркетплейсах в кратный рост — через SEO карточек, юнит-экономику и собственные AI-инструменты. Не задачи ради задач, а бизнес-результат в цифрах.',
} as const
...
export const EXPERTISE: ExpertiseItem[] = [
  {
    ...
    body: 'От анализа конкурентов и сбора семантического ядра до продающей инфографики и структуры под поисковые запросы маркетплейса.',
    scale: 'wide',
  },
  {
    index: '02',
...
export const EDGE_INTRO = {
  kicker: '02 — Почему со мной эффективнее',
...
export const EDGE: EdgeItem[] = [
  ...
  },
  {
    ...
    body: 'Автоматизирую рутину — сбор семантики, анализ ниш, генерацию и проверку контента. Больше времени остаётся на стратегию.',
  },
]
...
export const CONTACT_SECTION = {
  ...
  closing: 'Портфолио с разбором методов — в закрытом канале.',
}
